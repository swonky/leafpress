...
pub const DEFAULT_MAPPING: HighlightMap = HighlightMap {
    ...
    mappings: mappings![
        ...
        "function.macro" => h!(0x0d).italic(),
        "function.method" => h!(0x0d),
        "function.method.call" => h!(0x0d),
        "keyword" => h!(0x0e).bold(),
        "keyword.conditional" => h!(0x0e).bold(),
        "keyword.conditional.ternary" => h!(0x0e).bold(),
        "keyword.coroutine" => h!(0x0e).bold(),
        "keyword.debug" => h!(0x0e).bold(),
        "keyword.directive" => h!(0x0e).bold(),
        "keyword.directive.define" => h!(0x0e).bold(),
        "keyword.exception" => h!(0x08).bold(),
        "keyword.function" => h!(0x0e).bold(),
        "keyword.import" => h!(0x0e).bold(),
        "keyword.modifier" => h!(0x0e).bold(),
        "keyword.operator" => h!(0x0e).bold(),
        "keyword.repeat" => h!(0x0e).bold(),
        "keyword.return" => h!(0x0e).bold(),
        "keyword.type" => h!(0x0e).bold(),
        "label" => h!(0x0e),
        "markup" => h!(0x0f),
